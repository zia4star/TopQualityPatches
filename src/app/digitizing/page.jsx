...
export default function digitizing () {
    ...
    return(
        ...
        <>
            ...
            heading1="Chenille Digitizing"
            paragraph1="Looking for high-quality chenille digitizing services? Our expert team specializes in converting artwork into chenille-ready embroidery files that deliver bold, textured results. Whether you need chenille digitizing for varsity jackets, patches, or apparel branding, we provide precise and scalable designs compatible with all major embroidery machines. Using advanced software and years of experience, we ensure each chenille digitized file maintains rich detail, clean lines, and professional stitch quality. Trust us for fast turnaround, competitive pricing, and unbeatable craftsmanship. Perfect for apparel decorators, embroidery shops, and fashion brands looking to elevate their products with premium chenille embroidery."
            bgClass="bg-white"
            reverse={false}
            paraColor='text-black'
            headingColor='text-black'
